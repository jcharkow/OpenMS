...
namespace OpenMS
{
  /**
    ...
    The TargetedExperimentTwo can be stored to disk either in .traml format using
    the @ref TraMLFile "TraMLFile" or in .tsv format using the TransitionTSVFile.

  */
  class OPENMS_DLLAPI TargetedExperimentTwo
  {
public:
    ...
    struct OPENMS_DLLAPI SummaryStatistics
    {
      ...
      std::map<ReactionMonitoringTransitionTwo::DecoyTransitionType, size_t> decoy_counts; ///< # target/decoy transitions
    ...
    */
    //@{
    /// default constructor
    TargetedExperimentTwo();

    /// copy constructor
    TargetedExperimentTwo(const TargetedExperimentTwo & rhs);

    /// move constructor
    TargetedExperimentTwo(TargetedExperimentTwo && rhs) noexcept;

    /// destructor
    virtual ~TargetedExperimentTwo();
    //@}

    /// assignment operator
    TargetedExperimentTwo & operator=(const TargetedExperimentTwo & rhs);

    /// move assignment operator
    TargetedExperimentTwo & operator=(TargetedExperimentTwo && rhs) noexcept;

    /** @name Predicates
    */
    //@{
    bool operator==(const TargetedExperimentTwo & rhs) const;
    ...
    */
    TargetedExperimentTwo operator+(const TargetedExperimentTwo & rhs) const;
    ...
    */
    TargetedExperimentTwo& operator+=(const TargetedExperimentTwo & rhs);
    TargetedExperimentTwo& operator+=(TargetedExperimentTwo && rhs);
    ...
    */
    ...
    /// set transition list
    void setTransitions(const std::vector<ReactionMonitoringTransitionTwo> & transitions);
    void setTransitions(std::vector<ReactionMonitoringTransitionTwo> && transitions);

    /// returns the transition list
    const std::vector<ReactionMonitoringTransitionTwo> & getTransitions() const;

    /// adds a transition to the list
    void addTransition(const ReactionMonitoringTransitionTwo & transition);
    ...
    */
    ...
    /**
     * @brief appends using std::move() the contents of the given TargetedExperimentTwo to this one.
     * @param rhs The TargetedExperimentTwo to add to this one.
     ...
     */
    TargetedExperimentTwo & append(TargetedExperimentTwo && rhs);
...
protected:
    ...
    std::vector<ReactionMonitoringTransitionTwo> transitions_;
  ...
  namespace TargetedExperimentTwoHelper
  {
  } // namespace TargetedExperimentTwoHelper

  /// prints out the summary statistics
  OPENMS_DLLAPI std::ostream& operator<<(std::ostream& os, const TargetedExperimentTwo::SummaryStatistics& s);
