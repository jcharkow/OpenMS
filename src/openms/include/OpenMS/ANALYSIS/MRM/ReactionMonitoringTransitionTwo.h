...
namespace OpenMS
{
  ...
  /**
    ...
    uninitialized.
  */
  class OPENMS_DLLAPI ReactionMonitoringTransitionTwo
  {

public:

    typedef TargetedExperimentHelper::TraMLProductTwo Product;
    ...
    */
    //@{
    /// default constructor
    ReactionMonitoringTransitionTwo();

    /// copy constructor
    ReactionMonitoringTransitionTwo(const ReactionMonitoringTransitionTwo & rhs);

    /// Move constructor
    ReactionMonitoringTransitionTwo(ReactionMonitoringTransitionTwo&&) noexcept;
    ...
    /// assignment operator
    ReactionMonitoringTransitionTwo & operator=(const ReactionMonitoringTransitionTwo & rhs);

    /// move assignment operator
    ReactionMonitoringTransitionTwo & operator=(ReactionMonitoringTransitionTwo && rhs) noexcept ;
    ...
    */
    //@{
    /// equality operator
    bool operator==(const ReactionMonitoringTransitionTwo & rhs) const;
   ...
   */
    ...
    {
      inline bool operator()(ReactionMonitoringTransitionTwo const & left, ReactionMonitoringTransitionTwo const & right) const
      {
